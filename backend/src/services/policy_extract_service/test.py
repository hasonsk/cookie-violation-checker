...
class ContentExtractor:
    ...
    async def _process_content(
        ...
        if table_data:
            table_content_str = json.dumps([table for table in table_data], ensure_ascii=False, indent=2)
    ...
    async def extract_tables_from_page_html(self, html_content: str) -> List[dict]:
...
async def main():
    ...
    async with ContentExtractor() as extractor:
        ...
        output = {
            ...
            "table_content": [table for table in result.table_content],
